...
class Product extends ActiveRecord
{
    ...
    /**
     * @param $restrict_by_seller
     * @param Customer $customer
     * @return mixed
     * Devuelve un listado de los planes disponibles para un cliente
     */
    public static function getPlansBySellerAndCustomer(Customer $customer, $restrict_by_seller = false)
    {
        if($restrict_by_seller){
