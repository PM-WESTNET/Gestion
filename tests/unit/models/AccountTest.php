...
/*
    ...
    public function testUpdateTree()
    {
        ...
        expect('model dont have lft', $model->lft)->isEmpty();
        expect('model1 dont have lft', $model1->lft)->isEmpty();
        expect('model dont have rgt', $model->rgt)->isEmpty();
        expect('model1 dont have rgt', $model1->rgt)->isEmpty();

        $model->updateTree();
        $model1->updateTree();

        expect('model have lft', $model->lft)->isEmpty();
        expect('model1 have lft', $model1->lft)->isEmpty();
        expect('model have rgt', $model->rgt)->isEmpty();
        expect('model1 have rgt', $model1->rgt)->isEmpty();

        expect('model lft is rigth', $model->lft)->equals('ss');
        expect('model rgt is rigth', $model->rgt)->equals('ss');
        expect('model1 lft is rigth', $model1->lft)->equals('s');
        expect('model1 rgt is rigth', $model1->rgt)->equals('s');
    }
 */
