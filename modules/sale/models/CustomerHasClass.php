 ...
 */
class CustomerHasClass extends \app\components\db\ActiveRecord
{
    ...
    */
    ...
    {
        if ($insert) {
            $this->oldClass = $this->customer->customerClass;
        }
    ...
    public function afterSave($insert, $changedAttributes) {
        if ($insert && $this->oldClass && ($this->customer_class_id !== $this->oldClass->customer_class_id)) {
            $log= new CustomerLog();
            $log->createUpdateLog($this->customer_id, $this->attributeLabels()['customerClass'], $this->oldClass->name, $this->customerClass->name, 'Customer', $this->customerClass->customer_class_id);
        }
