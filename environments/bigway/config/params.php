...
return [
    //Data
    'adminEmail' => '*******',
    'web_title' => 'BIGWAY Local', //Por ejemplo, "Arya"
    'web_logo' => 'http://localhost/arya/web/iccmages/arya.png', //full path, por ejemplo 'http://localhost/arya/web/images/quoma.png',
