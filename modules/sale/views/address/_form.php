...
<div class="address-form">
    ...
    <?php $form = ActiveForm::begin(); ?>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <?= $form->field($model, 'zone_id')->label(Yii::t('app', 'Zone'))->dropDownList( ArrayHelper::map(Zone::find()->all(), 'zone_id', 'name' ), ['prompt' => Yii::t('app','Select')]) ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-9">
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <?= $form->field($model, 'between_street_1')->textInput(['maxlength' => 100]) ?>
                        </div>
                        <div class="col-xs-6">
                            <?= $form->field($model, 'between_street_2')->textInput(['maxlength' => 100]) ?>
                        </div>    
                    </div>
                    <div class="row">
                        <div class="col-xs-6">
                            <?= $form->field($model, 'block')->textInput(['maxlength' => 45]) ?>
                        </div>
                        <div class="col-xs-6">
                            <?= $form->field($model, 'house')->textInput(['maxlength' => 45]) ?>
                        </div>    
                    </div>
                    <div class="row">
                        <div class="col-xs-4">
                            <?= $form->field($model, 'tower')->textInput(['maxlength' => 45]) ?>
                        </div>
                        <div class="col-xs-4">
                            <?= $form->field($model, 'floor')->textInput() ?>
                        </div>    
                        <div class="col-xs-4">
                            <?= $form->field($model, 'department')->textInput(['maxlength' => 45]) ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <?= $form->field($model, 'indications')->textarea() ?>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6" id="localize">
...
<script type="text/javascript">
    var CustomerMap = new function() {
        ...
        this.init=function() {
            ...
            if($address->geocode) {
                $lt = explode(',', ($address->geocode==NULL ? "-32.8988839,-68.8194614": $address->geocode));
                if(count($lt)==2) {
        ...
        this.parseUrl = function(url) {
            ...
            if(position.length == 2) {
                $("#address-geocode").val(positionParsed);
