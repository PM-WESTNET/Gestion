...
/**
 * This is the model class for table "destinatary_has_plan".
 *
 ...
 */
class DestinataryHasPlan extends \app\components\db\ActiveRecord
{
    ...
    */
    ...
    {
        return [
            [['plan_id', 'destinatary_destinatary_id'], 'required'],
            [['plan_id', 'destinatary_destinatary_id'], 'integer']
        ];
    }
