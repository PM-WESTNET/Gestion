        ...
        <div class="col-sm-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body collapse in" id="panel-body-company" aria-expanded="true">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <?= $form->field($searchModel, 'company_id')->dropDownList(ArrayHelper::map(Company::findAll(['status'=>'enabled']), 'company_id', 'name'),[
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <?= $form->field($searchModel, 'product_id')->dropDownList(ArrayHelper::map(Plan::findAll(['type'=>'plan']), 'product_id', 'name'),[
                        ...
                        <div class="col-sm-6">
                            <?= $form->field($searchModel, 'customer_category_id')->dropDownList(ArrayHelper::map(CustomerCategory::find()->all(), 'customer_category_id', 'name'),[
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <?= $form->field($searchModel, 'server_id')->dropDownList(ArrayHelper::map(Server::find()->all(), 'server_id', 'name'),[
                        ...
                        <div class="col-sm-6">
                            <?= $form->field($searchModel, 'node_id')->dropDownList(ArrayHelper::map(Node::find()->all(), 'node_id', 'name'),[
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <?= $form->field($searchModel, 'new_company_id')->dropDownList(ArrayHelper::map(Company::findAll(['status'=>'enabled']), 'company_id', 'name'),[
                                'prompt'=> Yii::t('app', 'Select {modelClass}', ['modelClass'=>Yii::t('app','Company')]),
                                'encode'=>false,
                                'separator'=>'<br/>',
