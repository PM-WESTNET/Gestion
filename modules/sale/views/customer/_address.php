        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <div class="row">
                    <div class="col-xs-12">
                         <?=
                            $this->render('_find-zone-with-autocomplete', ['model' => $address, 'form' => $form, 'clear' => false])
                         ?>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-xs-12">
                            <?= $form->field($address, 'indications')->textarea() ?>
                    </div>
                </div>
                <?php if(Yii::$app->params['map_address'] && !isset($hideMap) || $hideMap == false):?>
                <div class="row">
                    <div class="col-xs-12">
                            <?= $form->field($address, 'geocode')->textInput(['value' => (empty($address->geocode) ? "-32.8988839,-68.8194614" : $address->geocode)])  ?>
                    </div>
                    <div class="col-xs-6">
