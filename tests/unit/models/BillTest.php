...
class BillTest extends \Codeception\Test\Unit
{
    ...
    public function testBillSearchWithFromDateAndPaymentMethodsFilters()
    {
        ...
        expect('No init bills with payment_method', $search->search($params)->getTotalCount())->equals(0);
        ...
        expect('No bills with payment_method before create bill', $search->search($params)->getTotalCount())->equals(0);
        ...
        expect('One bill', $search->search($params)->getTotalCount())->equals(1);
    }
