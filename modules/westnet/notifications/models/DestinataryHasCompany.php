...
/**
 * This is the model class for table "destinatary_has_company".
 *
 ...
 */
class DestinataryHasCompany extends \app\components\db\ActiveRecord
{
    ...
    {
        return 'destinatary_has_company';
    }
    ...
    */
    ...
    {
        return [
            [['company_id', 'destinatary_destinatary_id'], 'required'],
            [['company_id', 'destinatary_destinatary_id'], 'integer']
        ];
    }
