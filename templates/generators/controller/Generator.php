...
namespace app\templates\generators\controller;
...
class Generator extends \yii\gii\Generator {
    ...
    public function generate() {
        ...
        $files[] = new CodeFile(
                $this->getControllerFile(), $this->render('controller.php')
        );

        foreach ($this->getActionIDs() as $action) {
            $files[] = new CodeFile(
                    $this->getViewFile($action), $this->render('view.php', ['action' => $action])
            );
        }
