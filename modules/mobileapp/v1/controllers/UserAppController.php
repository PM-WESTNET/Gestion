...
class UserAppController extends Controller
{
    ...
    {
        return [
            'register' => ['GET','POST', 'OPTIONS'],
            'send-validation-code' => ['POST', 'OPTIONS'],
            'validate-code' => ['POST', 'OPTIONS'],
            'account' => ['POST', 'OPTIONS'],
            'view' => ['GET', 'HEAD', 'OPTIONS'],
            'update' => ['POST', 'OPTIONS'],
            'bill-pdf' => ['POST', 'GET', 'OPTIONS'],
            'ecopagos' => ['GET', 'OPTIONS'],
            'verify-customer' => ['POST','OPTIONS'],
            'verify-data' => ['POST', 'OPTIONS'],
            'set-document-number' => ['POST','OPTIONS'],
            'create-app-failed-register' => ['POST', 'OPTIONS'],
