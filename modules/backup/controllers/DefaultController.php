...
class DefaultController extends Controller {
    ...
    public function actionCreate() {
        ...
        $flashType = 'success';
        $flashMsg = Yii::t('backup','The backup has been created!');

        \Yii::$app->getSession()->setFlash($flashType, $flashMsg);
    ...
    public function actionDelete($file = null) {
        ...
        if (isset($file)) {
            ...
            if (file_exists($sqlFile)) {
                unlink($sqlFile);
                $flashType = 'success';
                $flashMsg = Yii::t('backup','The file {file} was successfully deleted.', ['file'=>$sqlFile]);
            } else {
                $flashType = 'error';
                $flashMsg = Yii::t('backup','The file {file} was not found.', ['file'=>$sqlFile]);
            }
        } else {
            $flashType = 'error';
            $flashMsg = Yii::t('backup','The file {file} was not found.', ['file'=>$sqlFile]);
    ...
    public function actionRestore($file = null) {
        ...
        if (isset($file)) {
            $sqlFile = $this->path . basename($file);
            $flashType = 'success';
            $flashMsg = Yii::t('backup','The database has been restored.');
        } else {
            $flashType = 'error';
            $flashMsg = Yii::t('backup','Problems with the file name.');
        }
