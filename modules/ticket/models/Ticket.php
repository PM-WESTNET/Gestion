...
class Ticket extends \app\components\db\ActiveRecord {
    ...
    {
        return $this->hasMany(History::class, ['ticket_id' => 'ticket_id'])->orderBy(['datetime' => SORT_DESC]);
    }
    ...
    {
        return $this->hasMany(Observation::class, ['ticket_id' => 'ticket_id'])->orderBy(['datetime' => SORT_DESC]);
    }
