...
class TaxesBookSearch extends ProviderBill
{
    ...
    public function findBuyTxt($params)
    {
        ...
        $sql = "SELECT
                    ...
                    (SUM(iva_105) + SUM(iva_21) + SUM(iva_27) + SUM(iva_06) + SUM(iva_05) + SUM(iva_025)) as credito_fiscal,
                    0                                                                           as otros_tributos,
                    0                                                                           as cuit_emisor,
                    ''                                                                          as emisor,
                    0                                                                           as iva_comision,
                    net                                                                         as neto,
                    code                                                                        as tipo_de_iva,
                    (SUM(iva_105) + SUM(iva_21) + SUM(iva_27) + SUM(iva_06) + SUM(iva_05) + SUM(iva_025)) as impuesto_liquidado,
