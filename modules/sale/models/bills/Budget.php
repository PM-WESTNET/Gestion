 ...
 */
class Budget extends \app\modules\sale\models\Bill
{
    /**
    ...
    {
        return new BillQuery(get_called_class(), ['class' => 'budget']);
    }
    ...
    {
        $this->expiration = $this->expiration ? Yii::$app->formatter->asDate($this->expiration, 'yyyy-MM-dd') : null;
