...
<div class="debtors-filters">
    ...
    <?php $form = ActiveForm::begin([
        'action' => ['positive-balance-customers'],
        'method' => 'get',
    ]); ?>
    ...
    <div class="row hidden-print">
        ...
        <div class="col-sm-4">
            ...
            <div class="input-group">
                ...
                <input type="text" id="customersearch-amount_due" class="form-control" name="CustomerSearch[amount_due_to]" value="<?php echo abs($searchModel->amount_due_to) ?>"/>
