...
$I->wantTo('ensure that sale works, Remito -> Factura A');
...
// Inicio comprobante
$I->clickMainMenu('Facturación', 'Remito');
if (Yii::$app->params['companies']['enabled']) {
    $I->selectOption('DeliveryNote[company_id]', 'ACME');
}
$I->wait(1); // only for selenium
$I->selectOption('DeliveryNote[bill_type_id]', 'Remito');
