...
<div class="firstdata-company-config-view">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Update'), ['update', 'id' => $model->firstdata_company_config_id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a(Yii::t('app', 'Delete'), ['delete', 'id' => $model->firstdata_company_config_id], [
