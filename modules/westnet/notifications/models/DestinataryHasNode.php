...
/**
 * This is the model class for table "destinatary_has_node".
 *
 ...
 */
class DestinataryHasNode extends \app\components\db\ActiveRecord
{
    ...
    */
    ...
    {
        return [
            [['node_id', 'destinatary_id'], 'required'],
            [['node_id', 'destinatary_id'], 'integer'],
            [['destinatary'], 'safe']
        ];
    }
