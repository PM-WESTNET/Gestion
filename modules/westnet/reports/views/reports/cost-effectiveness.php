...
<div class="customer-index">
    ...
    <div style="padding-top: 20px">
        ...
        <p>
            ...
            3 - Gastos bancarios : Se calcula el total en las cuentas correspondientes a 'GASTOS BANCARIOS'. <br>
            4 - <?= ReportsModule::t('app', 'Cost effectiveness')?> : <?= Yii::t('app', 'Earn')?> - <?= Yii::t('app', 'Provider payments')?> - Gastos bancarios. <br>
                Importante:
