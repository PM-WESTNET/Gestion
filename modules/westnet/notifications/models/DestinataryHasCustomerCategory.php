...
/**
 * This is the model class for table "destinatary_has_customer_category".
 *
 ...
 */
class DestinataryHasCustomerCategory extends \app\components\db\ActiveRecord
{
    ...
    {
        return 'destinatary_has_customer_category';
    }
    ...
    */
    ...
    {
        return [
            [['customer_category_id', 'destinatary_destinatary_id'], 'required'],
            [['customer_category_id', 'destinatary_destinatary_id'], 'integer']
        ];
    }
