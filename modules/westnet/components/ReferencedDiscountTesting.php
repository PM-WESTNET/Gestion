...
class ReferencedDiscountTesting
{
    ...
    public function applyDiscount(Payment $payment)
    {
        ...
        if($payment->customer->customer_reference_id) {
            ...
            foreach ($discounts as $discount) {
               	var_dump(Customer::hasFirstBillPayed($payment->customer_id), !$this->customerHasDiscount($payment->customer->customer_reference_id, $discount->discount_id));
