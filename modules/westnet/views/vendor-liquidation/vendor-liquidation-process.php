...
<div class="vendor-liquidation-view">
    ...
    <p class="pull-right">
        <?= UserA::a("<span class='glyphicon glyphicon-plus'></span> " . 'Calcular Comisiones (Nuevo Proceso)', 
                ...
                'buttons' => [
                    ...
                    'view' => function ($url, $model) {
                        if($model->status == 'pending')
                            return Html::a('<i class="glyphicon glyphicon-eye-open" ></i>', ['vendor-liquidation/view-vendor-liquidation-process', 'id' => $model->vendor_liquidation_process_id], ['data-pjax' => '0']);
                    }
                ]
            ]
        ]
