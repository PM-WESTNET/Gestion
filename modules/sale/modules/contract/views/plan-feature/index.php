...
/* @var $searchModel app\modules\sale\models\search\PlanFeatureSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Plan Features');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="plan-feature-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'filter'=>  yii\helpers\ArrayHelper::map(app\modules\sale\modules\contract\models\PlanFeature::find()->all(), 'plan_feature_id', 'name'),
