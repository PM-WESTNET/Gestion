...
class TaxesBookSearch extends ProviderBill
{
    ...
    public function findBuyTxt($params)
    {
        ...
        $sql = "SELECT
                    ...
                    ABS(total - net - SUM(retencion_ganancias) - SUM(conceptos_no_gravados) - SUM(percepcion_iva)) as credito_fiscal,
                    0                                                                           as otros_tributos,
                    0                                                                           as cuit_emisor,
                    ''                                                                          as emisor,
                    0                                                                           as iva_comision,
                    net                                                                         as neto,
                    code                                                                        as tipo_de_iva,
                    ABS(total - net - SUM(retencion_ganancias) - SUM(conceptos_no_gravados) - SUM(percepcion_iva)) as impuesto_liquidado,
